...
class Life_Settings {
	...
	/* Car-shop Settings */
	vehicleShop_rentalOnly[] = { "B_MRAP_01_hmg_F", "B_G_Offroad_01_armed_F", "rhs_btr80a_msv", "I_Plane_Fighter_03_CAS_F", "O_Plane_CAS_02_F", "B_Plane_CAS_01_F", "RHS_A10","RHS_Su25SM_vvs", "B_Heli_Light_01_armed_F", "rhs_prp3_vdv", "rhs_btr80_msv","rhs_t80b", "B_APC_Wheeled_01_cannon_F" ,"RHS_Mi8mt_vvs" ,"rhsusf_rg33_m2_d"};
	...
	"pickaxe", "fuelEmpty", "fuelFull", "spikeStrip", "lockpick", "goldBar", "blastingCharge", "boltCutter", "defuseKit", "storageSmall", "storageBig", "redgull",
	...
	"mulletRaw", "catsharkRaw", "turtleRaw", "henRaw", "roosterRaw", "sheepRaw", "goatRaw", "copperUnrefined", "copperRefined",
	"ironUnrefined", "ironRefined", "saltUnrefined", "saltRefined", "sand", "glass", "diamondUncut", "diamondCut", "rock", "cement", "heroinUnprocessed", "heroinProcessed",
	"cannabis", "marijuana", "cocaineUnprocessed", "cocaineProcessed", "mre", "mushrooms", "oil_diesel", "gas_unprocessed","gas_processed", "oil_jet", "oil_heavy",
	"hashish", "tea", "morphine", "krokodil", "khat", "meth_unprocessed", "meth_prcoessed", "chainsaw"
	};
};
...
class VirtualItems {
	...
	VITEMMACRO(iron_refined, "STR_Item_IronIngot", "ironRefined", 3, -1, 4590, false, -1, "")
	...
	VITEMMACRO(diamond_cut, "STR_Item_DiamondC", "diamondCut", 2, -1, 4153, false, -1, "")
	VITEMMACRO(rock, "STR_Item_Rock", "rock", 6, -1, -1, false, -1, "")
	VITEMMACRO(cement, "STR_Item_CementBag", "cement", 5, -1, 4153, false, -1, "")
	...
	VITEMMACRO(morphine, "STR_Item_Morphine", "morphine", 4, -1, 7500, true, -1, "")
	VITEMMACRO(krokodil, "STR_Item_Krokodil", "krokodil", 4, -1, 10000, true, -1, "")
	VITEMMACRO(cannabis, "STR_Item_Cannabis", "cannabis", 4, -1, -1, true, -1, "")
	VITEMMACRO(marijuana, "STR_Item_Marijuana", "marijuana", 3, -1, 3675, true, -1, "icons\ico_marijuana.paa")
	...
	VITEMMACRO(cocaine_processed, "STR_Item_CocaineP", "cocaineProcessed", 4, -1, 7399, true, -1, "")
	...
	//Spray Paint Items
	VITEMMACRO(paintBlack, "STR_Item_PaintBlack", "paintBlack", 1, 5000, 4000, false, -1, "")
	VITEMMACRO(paintWhite, "STR_Item_PaintWhite", "paintWhite", 1, 5000, 4000, false, -1, "")
	VITEMMACRO(paintRed, "STR_Item_PaintRed", "paintRed", 1, 5000, 4000, false, -1, "")
	VITEMMACRO(paintBlue, "STR_Item_PaintBlue", "paintBlue", 1, 5000, 4000, false, -1, "")
	VITEMMACRO(paintGreen, "STR_Item_PaintGreen", "paintGreen", 1, 5000, 4000, false, -1, "")
	VITEMMACRO(paintYellow, "STR_Item_PaintYellow", "paintYellow", 1, 5000, 4000, false, -1, "")
	VITEMMACRO(paintPurple, "STR_Item_PaintPurple", "paintPurple", 1, 5000, 4000, false, -1, "")
	VITEMMACRO(paintOrange, "STR_Item_PaintOrange", "paintOrange", 1, 5000, 4000, false, -1, "")
	VITEMMACRO(paintPink, "STR_Item_PaintPink", "paintPink", 1, 10000, 8000, false, -1, "")
	VITEMMACRO(paintCamo, "STR_Item_PaintCamo", "paintCamo", 1, 15000, 12000, false, -1, "")
	...
	//Drink
	VITEMMACRO(redgull, "STR_Item_RedGull", "redgull", 1, 150, 20, false, 100, "icons\ico_redgull.paa")
	...
	//Food
	VITEMMACRO(apple, "STR_Item_Apple", "apple", 1, 100, 50, false, 10, "icons\food.paa")
	VITEMMACRO(peach, "STR_Item_Peach", "peach", 1, 110, 55, false, 10, "icons\peach.paa")
	...
	VITEMMACRO(rabbit_raw, "STR_Item_Rabbit", "rabbitRaw", 2, -1, 650, false, -1, "icons\raw.paa")
	...
	VITEMMACRO(ornate_grilled, "STR_Item_OrnateGrilled", "ornateGrilled", 1, 750, 500, false, 25, "icons\ornate.paa")
	VITEMMACRO(mackerel_raw, "STR_Item_MackerelMeat", "mackerelRaw", 4, -1, 75, false, -1, "icons\mackerel.paa")
	VITEMMACRO(mackerel_grilled, "STR_Item_MackerelGrilled", "mackerelGrilled", 2, 750, 550, false, 30, "icons\mackerel.paa")
	VITEMMACRO(tuna_raw, "STR_Item_TunaMeat", "tunaRaw", 6, -1, 75, false, -1, "icons\tuna.paa")
	VITEMMACRO(tuna_grilled, "STR_Item_TunaGrilled", "tunaGrilled", 3, 750, 550, false, 100, "icons\tuna.paa")
	VITEMMACRO(mullet_raw, "STR_Item_MulletMeat", "mulletRaw", 4, -1, 250, false, -1, "icons\mullet.paa")
	VITEMMACRO(mullet_fried, "STR_Item_MulletFried", "mulletFried", 2, 550, 350, false, 80, "icons\mullet.paa")
	VITEMMACRO(catshark_raw, "STR_Item_CatSharkMeat", "catsharkRaw", 6, -1, 50, false, -1, "icons\shark.paa")
	VITEMMACRO(catshark_fried, "STR_Item_CatSharkFried", "catsharkFried", 3, 750, 550, false, 100, "icons\shark.paa")
	VITEMMACRO(turtle_raw, "STR_Item_TurtleMeat", "turtleRaw", 6, 950, 85, true, -1, "icons\turtle.paa")
	VITEMMACRO(turtle_soup, "STR_Item_TurtleSoup", "turtleSoup", 2, 850, 750, false, 100, "icons\soup.paa")
	VITEMMACRO(hen_raw, "STR_Item_HenRaw", "henRaw", 1, -1, 35, false, -1, "icons\raw.paa")
	VITEMMACRO(hen_fried, "STR_Item_HenFried", "henFried", 1, 1150, 850, false, 65, "icons\ico_cookedMeat.paa")
	VITEMMACRO(rooster_raw, "STR_Item_RoosterRaw", "roosterRaw", 1, -1, 35, false, -1,"icons\raw.paa")
	VITEMMACRO(rooster_grilled, "STR_Item_RoosterGrilled", "roosterGrilled", 1150, 850, false, 45, "icons\ico_cookedMeat.paa")
	VITEMMACRO(sheep_raw, "STR_Item_SheepRaw", "sheepRaw", 2, -1, 50, false, -1, "icons\raw.paa")
	VITEMMACRO(sheep_grilled, "STR_Item_SheepGrilled", "sheepGrilled", 2, 1550, 1150, false, 100, "icons\ico_cookedMeat.paa")
	VITEMMACRO(goat_raw, "STR_Item_GoatRaw", "goatRaw", 2, -1, 75, false, -1, "icons\raw.paa")
	VITEMMACRO(goat_grilled, "STR_Item_GoatGrilled", "goatGrilled", 2, 1750, 1350, false, 100, "icons\ico_cookedMeat.paa")
	VITEMMACRO(mre, "STR_Item_MRE", "mre", 2, 250, 20, false, 100, "")
};
...
class Licenses {
	...
	LICENSEMACRO(passport,"STR_License_Passport","passport",50000,false,"civ")
	...
	LICENSEMACRO(krokodil,"STR_License_Krokodil","krokodil",40000,false,"civ") 
...
class VirtualShops {
	...
	class rebel {
		...
		items[] = { "waterBottle", "rabbit_grilled", "apple", "redgull", "tbacon", "lockpick", "pickaxe", "fuelFull", "peach", "boltcutter", "blastingcharge", "chemset" };
	};
