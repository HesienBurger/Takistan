class CarShops {
	...
	*/
	...
	class TSF_armed {
		...
		vehicles[] = {
			{ "Gurkha_m60", 10000, "" },
			{ "DAR_MaxxPro_M2", 2000, ""},
			{ "DAR_MaxxProPlus", 2000, ""},
			{ "rhsusf_M1083A1P2_B_M2_d_fmtv_usarmy", 5000, "" }
		};
	};
	...
	class TSF_unarmed {
		...
		vehicles[] = {
			...
			{ "NRPG_Taki_Police_Car_F", 2500, "", { "life_coplevel", 5 } },
			{ "rhsusf_m998_w_4d", 2500, "", { "life_coplevel", 5 } },
			{ "rhsusf_m998_w_2dr", 2500, "", { "life_coplevel", 5 } },
			{ "O_MRAP_02_F", 99999999, "Event Award", { "life_coplevel", 999 } },
			{ "I_MRAP_03_F", 99999999, "Event Award", { "life_coplevel", 999 } }
		};
	}; 
  ...
  class nato_armed {
		side = "cop";
		vehicles[] = {
			{ "EWK_m1151_m240_deployment", 1000, ""},
			{ "EWK_m1151_m2_deployment_Jtac", 2000, ""},
			{ "EWK_m1151_m2_deployment_Bumper", 3000, ""},
			{ "EWK_M998A2_sov_M2", 5000, ""},
			{ "DAR_MaxxProDeploy", 6000, ""},
			{ "DAR_MaxxProPlus", 7500, ""},
			{ "DAR_MaxxProDXM", 10000, ""},
			{ "B_APC_Wheeled_01_cannon_", 10000, ""},
			{ "B_APC_Tracked_01_rcws_F", 11000, ""},
			{ "B_APC_Tracked_01_CRV_F", 15000, ""},
			{ "RHS_M2A3_BUSKIII", 20000, ""},
			{ "rhsusf_m1a1aim_tuski_d", 30000, ""}
		};
	};
	...
	class cop_air {
		...
		vehicles[] = {
			...
			{ "B_Heli_Transport_01_F", 5000, "cAir"},
			{ "B_UAV_02_F", 5000, "cAir"},
			{ "B_Heli_Light_01_armed_F", 5000, "cAir"},
			{ "RHS_C130J", 5000, "cAir"},
			{ "RHS_AH64D", 200000, "cAir", { "life_coplevel", 3 } },
...
class CfgVehicles {
	...
	class B_Heli_Light_01_F {
        ...
        textures[] = {
			...
			{ "Pink Digital", "reb", {
	            "textures\lb_pinkdigi.jpg"
            } },
			{ "Taxi", "civ", {
	            "textures\lb_taxi.jpg"
            } }
        };
    };
	...
	class O_Heli_Light_02_unarmed_F {
        ...
        textures[] = {
			...
			{ "White / Green", "civ", {
                "textures\orca_greenwhite.jpg"
            } },
			{ "Black / Pink", "civ", {
                "textures\orca_pinkblack.jpg"
            } },
			{ "White / Red", "civ", {
                "textures\orca_redwhite.jpg"
            } }
        };
    };
