...
if((_veh isKindOf "Car") OR (_veh isKindOf "Ship") OR (_veh isKindOf "Air") OR (_veh isKindOf "Tank")) then
{
		...
		_upp = format["Unlocking %1 with Jaws of Life",_displayName];
		...
		if(player != vehicle player) exitWith {titleText["Can't use this in a vehicle...","PLAIN"];};
		
		_veh lock 0;
		titleText["Car Unlocked","PLAIN"];
