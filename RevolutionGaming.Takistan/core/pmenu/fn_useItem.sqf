...
switch (true) do {
	...
	case (EQUAL(_item,"paintCamo")): {
		if(([false,_item,1] call life_fnc_handleInv)) then	{
			[[player, "paint",10],"life_fnc_playSound",true,false] spawn life_fnc_MP;
			sleep 5;
			[[cursorTarget,0,"textures\camo.jpg"],"life_fnc_setTexture",true,false] call life_fnc_MP;
			[[cursorTarget,1,"textures\camo.jpg"],"life_fnc_setTexture",true,false] call life_fnc_MP;
			[[cursorTarget,2,"textures\camo.jpg"],"life_fnc_setTexture",true,false] call life_fnc_MP;
		};
	};
